<?php
//echo "<pre>";var_export($_REQUEST);echo "</pre>";
//phpinfo();
...
if (isset($_SERVER) && isset($_SERVER['HTTP_HOST'])) {
	...
	// set in nginx config while it's still root	
	$wgDBname = $_SERVER['WGDNCP'];
	$wgDBuser = $_SERVER['WGDUCP'];
	$wgDBpassword = $_SERVER['WGDPCP']; 
	
	switch (php_uname('n')) {
	case 'santiago.att.net':  // cafe la boheme
	case 'santiago.local':
	case 'flores.local':
		$cwProdHost = false;
	...
	default:
		die("unknown net name ". php_uname('n'));
	}
}
else {
...
$wgEmergencyContact = "cw@tactileint.org";
$wgPasswordSender = "cw@tactileint.org";
...
$wgSecretKey = "1902adc21ac9a51acb9e8666ee525a18e24909f08fa963ce224070fbb8b7e9f5";

# Site upgrade key. Must be set to a string (default provided) to turn on the
# web installer while LocalSettings.php is in place
$wgUpgradeKey = "856ed35ee5658c9b";

## Default skin: you can change the default skin. Use the internal symbolic
## names, ie 'cologneblue', 'monobook', 'vector':
### must be all lowercase otherwise doesnt work.
$wgDefaultSkin = "vector";
//echo '$wgDefaultSkin = "crosswise" someday when i get it working<br>';
...
$wgSkipSkins = array();
// old cw v1 $wgSkipSkins = array('chick', 'standard', 'cologneblue', 'modern', 'monobook', 'myskin', 'nostalgia', 'simple');
...
# End of automatically generated settings.  Which I have already hacked up.  see .orig file.
# Add more configuration options below.
# allan's debugger thing
